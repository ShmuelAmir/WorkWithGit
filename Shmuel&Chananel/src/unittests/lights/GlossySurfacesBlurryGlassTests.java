...
public class GlossySurfacesBlurryGlassTests {
		...
		scene.geometries.add( //
				...
				new Triangle(new Point3D(1500, -1500, -1500), new Point3D(-1500, 1500, -1500),
						new Point3D(-1500, -1500, -2000)) //
								.setEmission(new Color(20, 20, 20)) //
								.setMaterial(new Material().setkR(0.5).setkG(0.2)));
	...
	public void GlossySurfacesBlurryGlassTest() {
		scene.geometries.add( //
				...
				new Sphere(new Point3D(0, 100, 18), 25) //
						.setEmission(new Color(java.awt.Color.BLUE)) //
						.setMaterial(new Material().setkD(0.4).setkS(0.3).setnShininess(100).setkT(0)),
				new Polygon(new Point3D(150, 70, 0), new Point3D(-150, 70, 0), new Point3D(-150, -250, 0),
						new Point3D(150, -250, 0)) //
							.setEmission(new Color(java.awt.Color.RED)) //
							.setMaterial(new Material().setkT(1).setkB(0.8)));
