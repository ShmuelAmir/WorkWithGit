...
public class Acceleration {
	...
	public void accelerationTest() {
		...
		scene.addGeometries(
				 ...
				 */
				/** SKY **/
				new Plane(new Point3D(50, -10, 700),new Point3D(0, 10, 500), new Point3D(10, -10, 700)).setEmission(new Color(102, 178, 255)),
				
				/** FLOOR **/
				new Plane(new Point3D(50, 10, 700), new Point3D(0, 10, 500), new Point3D(10, 10, 700)).setEmission(new Color(java.awt.Color.DARK_GRAY)).setMaterial(new Material().setkD())),
				
				new Plane(new Color(java.awt.Color.DARK_GRAY), new Material(0.2, 0.2, 60, 0, 0),
						),

				// SUN
				new Sphere(new Color(java.awt.Color.YELLOW), new Material(0, 0.5, 30, 0, 0), new Point3D(20, -100, 400),
						10),
				...
				// YADIT DOOR
				new Sphere(new Color(224, 224, 224), new Material(0, 0.8, 60, 0, 0),
				...
				new Triangle(new Color(java.awt.Color.BLACK), new Material(0, 0, 60, 0, 0), //
						new Point3D(80, 10, 0), new Point3D(80, -10, 0), new Point3D(83, -10, 0)),
				new Triangle(new Color(java.awt.Color.BLACK), new Material(0, 0, 60, 0, 0), //
						new Point3D(80, 10, 0), new Point3D(83, 10, 0), new Point3D(83, -10, 0)),
				...
				new Triangle(new Color(75, 209, 246), new Material(0.4, 0.1, 60, 0, 0.5), //
						new Point3D(30, 5, -700), new Point3D(0, 10, 0), new Point3D(80, 10, 0)),
				new Triangle(new Color(75, 209, 246), new Material(0.4, 0.1, 60, 0, 0.5), //
						new Point3D(30, 5, -700), new Point3D(0, 10, 0), new Point3D(0, 5, -700)),
				//
				new Triangle(new Color(160, 82, 45), new Material(0, 0.8, 60, 0, 0), //
						new Point3D(0, 5, -30), new Point3D(0, 10, 0), new Point3D(80, 10, 0)),
				new Triangle(new Color(160, 82, 45), new Material(0, 0.8, 60, 0, 0), //
						new Point3D(78, 5, -30), new Point3D(0, 5, -30), new Point3D(80, 10, 0)),

				new Triangle(new Color(160, 82, 45), new Material(0, 0.8, 60, 0, 0), //
						new Point3D(30.5, 4.75, -700), new Point3D(30, 5, -700), new Point3D(80, 10, 0)),
				new Triangle(new Color(160, 82, 45), new Material(0, 0.8, 60, 0, 0), //
						new Point3D(30.5, 4.75, -700), new Point3D(78, 5, -30), new Point3D(80, 10, 0)),

				new Triangle(new Color(160, 82, 45), new Material(0, 0, 60, 0, 0), //
						new Point3D(0, 5, -700), new Point3D(0, 4.75, -730), new Point3D(30, 5, -700)),
				new Triangle(new Color(160, 82, 45), new Material(0, 0, 60, 0, 0), //
						new Point3D(32, 4.9, -730), new Point3D(0, 4.75, -730), new Point3D(30.5, 5, -700)),
		...
		render.setAdaptiveSuperSamplingActive(false).setAdaptiveSuperSamplingSizeRays(80).setSoftShadowActive(true)
				.setSoftShadowRadius(0.01).setSoftShadowSizeRays(50).setMultithreading(3) //
				.setDebugPrint();
