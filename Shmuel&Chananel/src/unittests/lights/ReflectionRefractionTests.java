	...
	public void AllNewEffects() {
		...
		scene.geometries.add( //
				...
				new Triangle(new Point3D(55, -80, -90), new Point3D(40, -80, -90), new Point3D(55, -65, -90)) //
						.setMaterial(new Material().setkD(0.5).setkS(0.5).setnShininess(60)) //
						.setEmission(new Color(java.awt.Color.YELLOW)), //
				new Triangle(new Point3D(-50, 75, -100), new Point3D(-50, -75, -100), new Point3D(-100, 0, -150)) //
						.setMaterial(new Material().setkD(1).setkS(0).setnShininess(100)) //
						.setEmission(new Color(20, 20, 20)), //
				new Tube(new Ray(new Point3D(0, 0, -50), new Vector(1, 2, 2)), 5d) //
						.setMaterial(new Material().setkD(0.5).setkS(0.5).setnShininess(60)) //
						.setEmission(new Color(java.awt.Color.BLUE)), //
				new Polygon(new Point3D(50, 75, -100), new Point3D(-50, 75, -100), new Point3D(-50, -75, -100),
						new Point3D(50, -75, -100)) //
...
//
//		scene.geometries.add( //
//				new Tube(new Ray(new Point3D(-200, 65, 0), new Vector(1, 0, 0)), 5d) //
//						.setMaterial(new Material().setkD(0.5).setkS(0.5).setnShininess(60)) //
//						.setEmission(new Color(java.awt.Color.BLUE)), //
//				new Tube(new Ray(new Point3D(-200, -65, 0), new Vector(1, 0, 0)), 5d) //
//						.setMaterial(new Material().setkD(0.5).setkS(0.5).setnShininess(60)) //
//						.setEmission(new Color(java.awt.Color.BLUE)), //
//				new Polygon(new Point3D(200, 75, -5), new Point3D(-200, 75, -5), new Point3D(-200, -75, -5),
//						new Point3D(200, -75, -5)) //
//								.setMaterial(new Material().setkD(0.5).setkS(0.5).setnShininess(60)) //
//								.setEmission(new Color(java.awt.Color.WHITE)), //
//				new Triangle(new Point3D(-40, -25, 1), new Point3D(40, -25, 1), new Point3D(0, 50, 1)) //
//						.setMaterial(new Material().setkD(0.5).setkS(0.5).setnShininess(60)) //
//						.setEmission(new Color(java.awt.Color.BLUE)), //
//				new Triangle(new Point3D(-40, 25, 0), new Point3D(40, 25, 0), new Point3D(0, -50, 0)) //
//						.setMaterial(new Material().setkD(0.5).setkS(0.5).setnShininess(60)) //
//						.setEmission(new Color(java.awt.Color.BLUE)) //
//		);
//
